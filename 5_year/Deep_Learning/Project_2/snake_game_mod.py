...
class SnakeGame:
    ...
    def step(self, action):        
        ...
        new_distance_apple = math.dist(self.apples[0], self.snake[0])
        #print(self.distance_apple)
        #print(new_distance_apple)
        if new_distance_apple <= self.distance_apple:
            reward = 1
        else:
            reward = -1
            
        self.distance_apple = new_distance_apple
    ...
    def reset(self):
        ...
        self.distance_apple = math.dist(self.apples[0], self.snake[0])
